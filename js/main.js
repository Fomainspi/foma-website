...
// Dev uses the dedicated Dev backend; Production uses the new Production backend.
const PRODUCTION_REGISTER_ENDPOINT = 'https://7gd3r709wf.execute-api.ap-southeast-1.amazonaws.com/prod/register';
