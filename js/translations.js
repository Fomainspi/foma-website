...
const translations = {
    en: {
        ...
        newsletter_hero_title: "FOMA Newsletter",
        newsletter_hero_subtitle: "Practical DevOps, DevSecOps, Cloud, Kubernetes and automation insights.",
        newsletter_loading: "Loading newsletters...",
        newsletter_empty: "No newsletters available yet.",
        newsletter_error: "Unable to load newsletters.",
        newsletter_read_more: "Read Newsletter",
        back_to_newsletters: "Back to Newsletters",
        newsletter_article_not_found: "Newsletter not found.",
        about: "About",
        contact: "Contact",
        ...
        module_2: "Git & GitHub",
        module_3: "Docker",
        module_4: "CI/CD (Jenkins)",
        module_5: "Kubernetes",
        module_6: "Cloud (AWS basics)",
        module_7: "Final Project",
        projects_title: "Build Real DevOps Projects",
        projects_intro: "Practice with real deployment workflows and production-style scenarios.",
        project_item_1: "CI/CD pipeline",
        project_item_2: "Containerized applications",
        project_item_3: "Kubernetes deployments",
        project_item_4: "Cloud deployments",
        register_title: "Join the Next DevOps Bootcamp",
        register_desc: "Limited seats available. Register your interest and get full details.",
        ...
        form_goal: "Goal",
        form_goal_job: "Job",
        form_goal_skill: "Skill upgrade",
        form_goal_career: "Career change",
        join_now: "Join Now",
        instructor_title: "About the Instructor",
        instructor_desc: "DevOps Engineer with real-world experience, passionate about mentoring and focused on practical, job-ready training.",
        latest_articles: "Latest Articles",
        search_articles: "Search articles...",
        office_address: "Parañaque City, Philippines",
        project_read_time: "12 min read",
        project_cicd_category: "CI/CD Project",
        project_cicd_title: "Build a Complete CI/CD Pipeline with Jenkins",
        project_cicd_section_1_title: "Content",
        project_cicd_section_1_text: "Learn how to design and implement a complete Continuous Integration and Continuous Deployment (CI/CD) pipeline from scratch.",
        project_cicd_section_2_title: "In this project, you will:",
        project_cicd_point_1: "Set up a Jenkins server",
        project_cicd_point_2: "Connect a GitHub repository",
        project_cicd_point_3: "Automate build and test processes",
        project_cicd_point_4: "Create a deployment pipeline",
        project_cicd_point_5: "Implement pipeline as code (Jenkinsfile)",
        project_cicd_section_3_title: "Outcome",
        project_cicd_point_6: "Automate software delivery",
        project_cicd_point_7: "Understand real-world CI/CD workflows",
        project_cicd_point_8: "Deploy applications efficiently",
        project_docker_category: "Docker Project",
        project_docker_title: "Containerize and Deploy an Application with Docker",
        project_docker_section_1_title: "Content",
        project_docker_section_1_text: "This project focuses on packaging applications into containers using Docker.",
        project_docker_section_2_title: "You will:",
        project_docker_point_1: "Create Dockerfiles",
        project_docker_point_2: "Build Docker images",
        project_docker_point_3: "Run and manage containers",
        project_docker_point_4: "Use Docker Compose for multi-service apps",
        project_docker_point_5: "Push images to Docker Hub",
        project_docker_section_3_title: "Outcome",
        project_docker_point_6: "Understand containerization deeply",
        project_docker_point_7: "Build portable applications",
        project_docker_point_8: "Prepare apps for cloud deployment",
        project_k8s_category: "Kubernetes Project",
        project_k8s_title: "Deploy and Manage Applications on Kubernetes",
        project_k8s_section_1_title: "Content",
        project_k8s_section_1_text: "Learn how to orchestrate containerized applications using Kubernetes.",
        project_k8s_section_2_title: "You will:",
        project_k8s_point_1: "Set up a Kubernetes cluster (Minikube or cloud)",
        project_k8s_point_2: "Create deployments and services",
        project_k8s_point_3: "Scale applications",
        project_k8s_point_4: "Manage pods",
        project_k8s_point_5: "Use YAML configuration files",
        project_k8s_section_3_title: "Outcome",
        project_k8s_point_6: "Understand container orchestration",
        project_k8s_point_7: "Deploy scalable applications",
        project_k8s_point_8: "Work with production-like environments",
        project_cloud_category: "Cloud Project",
        project_cloud_title: "Deploy a Full DevOps Project to the Cloud (AWS)",
        project_cloud_section_1_title: "Content",
        project_cloud_section_1_text: "Take your DevOps skills to the next level by deploying applications to the cloud.",
        project_cloud_section_2_title: "You will:",
        project_cloud_point_1: "Launch EC2 instances",
        project_cloud_point_2: "Configure servers",
        project_cloud_point_3: "Deploy containerized applications",
        project_cloud_point_4: "Set up networking and security",
        project_cloud_point_5: "Monitor your application",
        project_cloud_section_3_title: "Outcome",
        project_cloud_point_6: "Gain real cloud experience",
        project_cloud_point_7: "Understand infrastructure deployment",
        project_cloud_point_8: "Be ready for real DevOps roles",
    ...
    fr: {
        // Header Navigation
        home: "Accueil",
        program_nav: "Programme",
        projects_nav: "Projets",
        register_nav: "Inscription",
        blog: "Blog",
        newsletter: "Newsletter",
        newsletter_hero_title: "Newsletter FOMA",
        newsletter_hero_subtitle: "Des conseils pratiques sur le DevOps, le DevSecOps, le Cloud, Kubernetes et l'automatisation.",
        newsletter_loading: "Chargement des newsletters...",
        newsletter_empty: "Aucune newsletter disponible pour le moment.",
        newsletter_error: "Impossible de charger les newsletters.",
        newsletter_read_more: "Lire la newsletter",
        back_to_newsletters: "Retour aux newsletters",
        newsletter_article_not_found: "Newsletter introuvable.",
        about: "À propos",
        contact: "Contact",
        ...
        module_4: "CI/CD (Jenkins)",
        module_5: "Kubernetes",
        module_6: "Cloud (bases AWS)",
        module_7: "Projet Final",
        projects_title: "Réalisez de vrais projets DevOps",
        projects_intro: "Pratiquez avec des workflows de déploiement réels et des scénarios type production.",
        project_item_1: "Pipeline CI/CD",
        project_item_2: "Applications conteneurisées",
        project_item_3: "Déploiements Kubernetes",
        project_item_4: "Déploiements Cloud",
        register_title: "Rejoignez le prochain Bootcamp DevOps",
        register_desc: "Places limitées. Inscrivez votre intérêt et recevez tous les détails.",
        ...
        form_goal: "Objectif",
        form_goal_job: "Emploi",
        form_goal_skill: "Montée en compétences",
        form_goal_career: "Reconversion",
        join_now: "Rejoindre",
        instructor_title: "À propos de l'instructeur",
        instructor_desc: "Ingénieur DevOps avec une expérience terrain, passionné par le mentorat et axé sur une formation pratique orientée emploi.",
        latest_articles: "Derniers articles",
        search_articles: "Rechercher des articles...",
        office_address: "Parañaque City, Philippines",
        project_read_time: "12 min de lecture",
        project_cicd_category: "Projet CI/CD",
        project_cicd_title: "Construire un pipeline CI/CD complet avec Jenkins",
        project_cicd_section_1_title: "Contenu",
        project_cicd_section_1_text: "Apprenez à concevoir et implémenter un pipeline complet d'Intégration Continue et de Déploiement Continu (CI/CD) depuis zéro.",
        project_cicd_section_2_title: "Dans ce projet, vous allez :",
        project_cicd_point_1: "Configurer un serveur Jenkins",
        project_cicd_point_2: "Connecter un dépôt GitHub",
        project_cicd_point_3: "Automatiser les processus de build et de test",
        project_cicd_point_4: "Créer un pipeline de déploiement",
        project_cicd_point_5: "Implémenter le pipeline as code (Jenkinsfile)",
        project_cicd_section_3_title: "Résultat",
        project_cicd_point_6: "Automatiser la livraison logicielle",
        project_cicd_point_7: "Comprendre les workflows CI/CD du monde réel",
        project_cicd_point_8: "Déployer des applications efficacement",
        project_docker_category: "Projet Docker",
        project_docker_title: "Conteneuriser et déployer une application avec Docker",
        project_docker_section_1_title: "Contenu",
        project_docker_section_1_text: "Ce projet se concentre sur le packaging des applications dans des conteneurs avec Docker.",
        project_docker_section_2_title: "Vous allez :",
        project_docker_point_1: "Créer des Dockerfiles",
        project_docker_point_2: "Construire des images Docker",
        project_docker_point_3: "Executer et gerer des conteneurs",
        project_docker_point_4: "Utiliser Docker Compose pour des applications multi-services",
        project_docker_point_5: "Pousser les images vers Docker Hub",
        project_docker_section_3_title: "Résultat",
        project_docker_point_6: "Comprendre la conteneurisation en profondeur",
        project_docker_point_7: "Construire des applications portables",
        project_docker_point_8: "Preparer les applications pour le deploiement cloud",
        project_k8s_category: "Projet Kubernetes",
        project_k8s_title: "Déployer et gérer des applications sur Kubernetes",
        project_k8s_section_1_title: "Contenu",
        project_k8s_section_1_text: "Apprenez à orchestrer des applications conteneurisées avec Kubernetes.",
        project_k8s_section_2_title: "Vous allez :",
        project_k8s_point_1: "Configurer un cluster Kubernetes (Minikube ou cloud)",
        project_k8s_point_2: "Creer des deployments et services",
        project_k8s_point_3: "Scaler les applications",
        project_k8s_point_4: "Gerer les pods",
        project_k8s_point_5: "Utiliser des fichiers de configuration YAML",
        project_k8s_section_3_title: "Résultat",
        project_k8s_point_6: "Comprendre l'orchestration de conteneurs",
        project_k8s_point_7: "Deployer des applications scalables",
        project_k8s_point_8: "Travailler avec des environnements proches de la production",
        project_cloud_category: "Projet Cloud",
        project_cloud_title: "Déployer un projet DevOps complet dans le Cloud (AWS)",
        project_cloud_section_1_title: "Contenu",
        project_cloud_section_1_text: "Passez au niveau superieur en DevOps en deployant des applications dans le cloud.",
        project_cloud_section_2_title: "Vous allez :",
        project_cloud_point_1: "Lancer des instances EC2",
        project_cloud_point_2: "Configurer des serveurs",
        project_cloud_point_3: "Deployer des applications conteneurisees",
        project_cloud_point_4: "Mettre en place le reseau et la securite",
        project_cloud_point_5: "Surveiller votre application",
        project_cloud_section_3_title: "Résultat",
        project_cloud_point_6: "Acquerir une vraie experience cloud",
        project_cloud_point_7: "Comprendre le deploiement d'infrastructure",
        project_cloud_point_8: "Etre pret pour de vrais roles DevOps",
